...
var _user$project$Widgets$renderSvg = F3(
	function (svgWidth, svgHeight, values) {
		return A2(
...
var _user$project$Widgets$translateToString = F2(
	function (x, y) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'translate(',
...
var _user$project$Widgets$sparklineBar = F4(
	function (barHeight, barY, barWidth, barPosition) {
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A2(_user$project$Widgets$translateToString, barPosition, barY)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$svg$Svg$rect,
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$height(
							_elm_lang$core$Basics$toString(barHeight)),
						_1: {
							ctor: '::',
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$width(
									_elm_lang$core$Basics$toString(barWidth)),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _user$project$Widgets$sparklines = function (values) {
	var barPadding = 2;
	var barWidth = 3;
	var isPositive = F2(
		function (x, y) {
	...
	var barLargestPositiveValue = A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		_elm_lang$core$List$maximum(
			A2(_elm_lang$core$List$filter, isPositive, values)));
	var barY = function (barHeight) {
		var _p0 = isPositive(barHeight);
		if (_p0 === true) {
			return barLargestPositiveValue - barHeight;
		} else {
			return barLargestPositiveValue;
		}
	};
	return A2(
		_elm_lang$core$List$map,
		function (_p1) {
			...
			var _p3 = _p2._0;
			return A4(
				_user$project$Widgets$sparklineBar,
				_elm_lang$core$Basics$abs(_p3),
				barY(_p3),
				barWidth,
				_p2._1);
		},
...
var _user$project$Widgets$sparkChart = F3(
	function (width, height, values) {
		return A3(
			_user$project$Widgets$renderSvg,
			width,
			height,
			_user$project$Widgets$sparklines(values));
	});

var _user$project$TrySVG$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$TrySVG$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Msg1') {
...
var _user$project$TrySVG$modelInitialValue = {property: 1};
var _user$project$TrySVG$init = {ctor: '_Tuple2', _0: _user$project$TrySVG$modelInitialValue, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$TrySVG$Model = function (a) {
	return {property: a};
};
var _user$project$TrySVG$Myvalue = F4(
	function (a, b, c, d) {
		return {one: a, two: b, three: c, four: d};
	});
var _user$project$TrySVG$view = function (model) {
	var x = {
		ctor: '::',
		_0: A4(_user$project$TrySVG$Myvalue, 1, 2, 3, 4),
		_1: {
			ctor: '::',
			_0: A4(_user$project$TrySVG$Myvalue, 2, 4, 6, 8),
			_1: {
				ctor: '::',
				_0: A4(_user$project$TrySVG$Myvalue, 3, 6, 9, 12),
				_1: {
					ctor: '::',
					_0: A4(_user$project$TrySVG$Myvalue, 4, 8, 12, 16),
					_1: {
						ctor: '::',
						_0: A4(_user$project$TrySVG$Myvalue, 5, 10, 15, 20),
						_1: {
							ctor: '::',
							_0: A4(_user$project$TrySVG$Myvalue, 4, 8, 12, 16),
							_1: {
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('More text'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Even more text'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: A3(
									_user$project$Widgets$sparkChart,
									40,
									40,
									{
										ctor: '::',
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A3(
										...
										80,
										80,
										A2(_elm_lang$core$List$range, 40, 100)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
var _user$project$TrySVG$main = _elm_lang$html$Html$program(
	{init: _user$project$TrySVG$init, view: _user$project$TrySVG$view, update: _user$project$TrySVG$update, subscriptions: _user$project$TrySVG$subscriptions})();
var _user$project$TrySVG$Msg2 = {ctor: 'Msg2'};
var _user$project$TrySVG$Msg1 = {ctor: 'Msg1'};

var Elm = {};
Elm['TrySVG'] = Elm['TrySVG'] || {};
if (typeof _user$project$TrySVG$main !== 'undefined') {
    _user$project$TrySVG$main(Elm['TrySVG'], 'TrySVG', {"types":{"message":"TrySVG.Msg","aliases":{},"unions":{"TrySVG.Msg":{"tags":{"Msg1":[],"Msg2":[]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
Elm['Widgets'] = Elm['Widgets'] || {};
if (typeof _user$project$Widgets$main !== 'undefined') {
    _user$project$Widgets$main(Elm['Widgets'], 'Widgets', {"types":null,"versions":{"elm":"0.18.0"}});
}
